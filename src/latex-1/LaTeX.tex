...
\date{13.10.2022} % Date, can be changed to a custom date
...
\[f(x)=(\sum_{k=1}^{n}\underbrace{\frac{5(x+3)}{5}}_{=x+3})+g(x)\]
"HEY! Das sieht blöd aus!"\pause
...
\begin{frame}[fragile]
\frametitle{Text über dem Gleichzeichen}
